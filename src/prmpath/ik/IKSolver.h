...
enum Constraint{FTR, AxisAlign, Unknown};

class IKSolver
{

public:
     IKSolver(const float espilon = 0.001f, const float treshold = 0.001f, const float stepSize = 0.001f, const float stepsizeOptim=0.01f);
	~IKSolver();
...
public:
    ...
    void PartialDerivatives(planner::Node* /*limb*/, const Eigen::Vector3d& /*direction*/, Eigen::VectorXd& /*velocities*/) const;
...
private:
    ...
    std::vector<PartialDerivativeConstraint*> constraints;
};
} // namespace ik
